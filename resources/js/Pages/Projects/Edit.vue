<template>
            ...
            <div class="py-12">
                <div class="max-w-md mx-auto sm:px-6 lg:px-8 bg-white">
                   <form @submit.prevent="submit" class="p-4">
                            ...
                            <div>
                                <InputLabel for="skill_id" value="Pick Skill" />
                               <select v-model="form.skill_id" id="skill_id" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 sm:text-sm rounded-md">
    ...
    const submit = () => {
        Inertia.post(route('projects.update',props.project),{
            _method:"put",
            'name':form.name,
            'image':form.image,
