...
<!-- ====== Hero Section Start -->
<div id="hero" class="relative bg-white pt-[60px] pb-[60px] lg:pt-[100px]">
  <div class="container mx-auto">
    <div class="-mx-4 flex flex-wrap">
      <div class="w-full px-4 lg:w-5/12">
        <div class="hero-content">
          ...
          <p class="text-body-color mb-8 max-w-[480px] text-base">
            With Php,Laravel,Vue.js,Bootstrap,HTML,Css,Javascript .
          </p>
          <div class="pt-12">
            <h5 class="text-lg flex items-center text-black">Follow me On</h5>
      ...
      <div class="hidden px-1 lg:block lg:w-1/12"></div>
      <div class="w-full px-1 lg:w-6/12">
        <div class="lg:ml-auto lg:text-right">
          <div class="relative z-10 inline-block pt-4 lg:pt-0">
            <img
              src='/images/hero.jpg'
              alt="hero"
